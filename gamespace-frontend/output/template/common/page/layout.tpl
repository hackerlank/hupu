...
<title>
{%block name="title"%}{%$title|default:'虎扑体育'|f_escape_xml%}{%/block%}
</title>
{%block name="metaseo"%}
...
{%/block%}
{%$posheader="header"%}
{%$posheader|echo_include|f_escape_xml%}
...
{%$posfooterlevel|echo_include|f_escape_xml%}
{%block name="content"%}{%/block%}
{%$posfooter="footer"%}
{%$posfooter|echo_include|f_escape_xml%}
