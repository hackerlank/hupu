...
<tr>
<td width="46">{%$item.rank|f_escape_xml%}</td>
<td width="142" class="left"><a href="{%$item.player_link|f_escape_xml%}">{%$item.player_name|f_escape_xml%}</a></td>
<td width="50"><a href="{%$item.team_link|f_escape_xml%}">{%$item.team_name|f_escape_xml%}</a></td>
{%if $rank_type == "pts"%}
<td class="bg_b">{%$item.pts|f_escape_xml%}</td>
<td>{%$item.fgm|f_escape_xml%}-{%$item.fga|f_escape_xml%}</td>
<td>{%$item.fgp|f_escape_xml%}</td>
<td>{%$item.tpm|f_escape_xml%}-{%$item.tpa|f_escape_xml%}</td>
<td>{%$item.tpp|f_escape_xml%}</td>
<td>{%$item.ftm|f_escape_xml%}-{%$item.fta|f_escape_xml%}</td>
<td>{%$item.ftp|f_escape_xml%}</td>
{%else if $rank_type == "fgp"%}
<td class="bg_b">{%$item.fgp|f_escape_xml%}</td>
<td>{%$item.adp|f_escape_xml%}</td>
<td>{%$item.fgm|f_escape_xml%}-{%$item.fga|f_escape_xml%}</td>
<td>{%$item.tpm|f_escape_xml%}-{%$item.tpa|f_escape_xml%}</td>
{%else if $rank_type == "tpp"%}
<td class="bg_b">{%$item.tpp|f_escape_xml%}</td>
<td>{%$item.tpm|f_escape_xml%}</td>
<td>{%$item.tpa|f_escape_xml%}</td>
<td>{%$item.pts|f_escape_xml%}</td>
{%else if $rank_type == "ftp"%}
<td class="bg_b">{%$item.ftp|f_escape_xml%}</td>
<td>{%$item.ftm|f_escape_xml%}</td>
<td>{%$item.fta|f_escape_xml%}</td>
<td>{%$item.pts|f_escape_xml%}</td>
{%else if $rank_type == "reb"%}
<td class="bg_b">{%$item.reb|f_escape_xml%}</td>
<td>{%$item.oreb|f_escape_xml%}</td>
<td>{%$item.dreb|f_escape_xml%}</td>
{%else if $rank_type == "asts"%}
<td class="bg_b">{%$item.asts|f_escape_xml%}</td>
<td>{%$item.to|f_escape_xml%}</td>
<td>{%$item.asts_to|f_escape_xml%}</td>
{%else if $rank_type == "blk"%}
<td class="bg_b">{%$item.blk|f_escape_xml%}</td>
<td>{%$item.pf|f_escape_xml%}</td>
<td>{%$item.blk_pf|f_escape_xml%}</td>
{%else if $rank_type == "stl"%}
<td class="bg_b">{%$item.stl|f_escape_xml%}</td>
<td>{%$item.to|f_escape_xml%}</td>
<td>{%$item.pf|f_escape_xml%}</td>
<td>{%$item.stl_to|f_escape_xml%}</td>
<td>{%$item.stl_pf|f_escape_xml%}</td>
{%/if%}
<td width="50">{%$item.games|f_escape_xml%}</td>
<td width="70">{%$item.mins|f_escape_xml%}</td>
</tr>
{%/foreach%}
</tbody>
</table>
...
{%require name='match:page/data-players.tpl'%}{%/block%}
