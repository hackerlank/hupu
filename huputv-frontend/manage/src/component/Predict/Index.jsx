...
const Api = {
    ...
    stop: '/manage/topic/stop/:id',
    cancel: '/manage/topic/cancel/:id'
}
...
class Predict extends Component {
  ...
  renderOption(text, record, index) {
      ...
      return (
          <div>
              <p><a href="javascript:" onClick={this.handleOptionModal.bind(this, text)}>共{text.length}个选项</a></p>
              <p>参与：{totalNumber(text)}</p>
          </div>
      )
  }
  ...
  render() {
    ...
    const columns = [
        ...
        { title: '直播间标题', dataIndex: 'room_name', key: 'room_name',
        ...
        { title: '预测题标题', dataIndex: 'title', key: 'title', width: '25%'},
        { title: '题目得分', dataIndex: 'score', key: 'score' },
        { title: '选项详细', dataIndex: 'option', key: 'option',
            render:  this.renderOption.bind(this)
        },
    ...
    let pagination1 = {
        ...
        onChange: this.getStatusList1.bind(this),
    ...
    let pagination2 = {
        ...
        pageSize: this.state.size,
        onChange: this.getStatusList2.bind(this),
    ...
    return (
      <div>
        <h3 style={{marginBottom: 10}}> 预测题列表 </h3>
        ...
        <OptionModal
          ...
          handleCancel={this.handleOptionCancel.bind(this)}
...
export default Form.create()(Predict);
