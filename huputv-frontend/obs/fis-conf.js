...
fis.match('::package', {
    ...
    packager: fis.plugin('map', {
        ...
        'static/pkg/index.css': [
            'static/index/index.scss',
            'widget/title/title.scss'
        ],
        'static/pkg/myfollow.css': [
            'widget/user-nav/user-nav.scss',
            'static/followList/followList.scss'
        ],
        'static/pkg/share.css': [
            'static/share/*.scss',
            'widget/download/*.scss'
        ],
        'static/pkg/index.js': [
            'static/index/jquery.lazyload.min.js',
