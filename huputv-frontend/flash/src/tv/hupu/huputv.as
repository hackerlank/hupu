package tv.hupu{
    ...
    import tv.hupu.Base64;
    import tv.hupu.VideoJSApp;
    ...
    public class huputv extends Sprite{
        ...
        private function init():void{
            ...
            var _ctxVersion:ContextMenuItem = new ContextMenuItem("©2016 HupuTV v" + CONFIG::version, false, false);
...
//			_app.model.rtmpConnectionURL = "rtmp://ws.live.hupucdn.com/prod/";
//			_app.model.rtmpStream= "8ff5008bcd1856ad30b15d355415d79d";
        ...
        private function onUncaughtError(e:UncaughtErrorEvent):void{
			...
			Statistics.getInstance().sendError(message);
            e.preventDefault();
        }
