 ...
 * 仅支持7.0.5以后的版本
 */
var Versions = require("app:widget/ui-versions/ui-versions.js");
...
var app = {
	...
	checkLogin: function(callback, isLogin) {
		if (!!isLogin) {
			...
			this.sendHandler("hupu.user.login", {}, function(user) {
				callback(user);
			});
		}
	},
	...
	getVersion: function(defaultVer) {
		...
		var nainfo = (window.HupuBridge && HupuBridge.nainfo) ? HupuBridge.nainfo :
			defaultInfo;
