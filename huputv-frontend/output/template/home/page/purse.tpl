...
<div class="clearfix">
<div class="fl">
<span class="span_1">虎扑币余额</span><span class="span_2">{%$balance["6"]|f_escape_xml%}</span>
</div>
<a href="{%$recharge_url|f_escape_xml%}" target="_blank" id="rechange">充值</a>
</div>
...
<div class="clearfix">
<div class="fl">
<span class="span_1">金豆余额</span><span class="span_2">{%$balance["1"]|f_escape_xml%}</span>
</div>
<a href="{%$beans_recharge_url|f_escape_xml%}" id="buy">购买</a>
</div>
...
{%require name='home:page/purse.tpl'%}{%/block%}
