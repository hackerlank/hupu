<?php /* Smarty version Smarty-3.1.13, created on 2016-06-14 16:35:12
         compiled from "/data/www-data/hupu.com/huputv_frontend/template/home/page/followList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:934812028575fc1c0b30a09-52781759%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '78a3592d45fa8ea1d7ec7a36c67a1ab4f4ef3c28' => 
    array (
      0 => '/data/www-data/hupu.com/huputv_frontend/template/home/page/followList.tpl',
      1 => 1465893266,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '934812028575fc1c0b30a09-52781759',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_575fc1c0d300b1_71839188',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_575fc1c0d300b1_71839188')) {function content_575fc1c0d300b1_71839188($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_f_escape_xml')) include '/data/www-data/hupu.com//huputv_frontend/plugin/modifier.f_escape_xml.php';
...
<?php if(!class_exists('FISResource', false)){require_once('/data/www-data/hupu.com/huputv_frontend/plugin/FISResource.class.php');}FISResource::load("home:static/followList/followList.scss",$_smarty_tpl->smarty, false);?>
<?php if(!class_exists('FISResource', false)){require_once('/data/www-data/hupu.com/huputv_frontend/plugin/FISResource.class.php');}FISResource::load("common:static/js/jquery/jquery-1.12.0.min.js",$_smarty_tpl->smarty, false);?>
...
<div class="tags mod-overflow"><?php if (!empty($_smarty_tpl->tpl_vars['val']->value['tips'])){?><?php echo smarty_modifier_f_escape_xml($_smarty_tpl->tpl_vars['val']->value['tips']);?>
<?php }?></div>
<div class="follow">
<?php if (!empty($_smarty_tpl->tpl_vars['show_follow']->value)){?>
<div class="num">关注人数：<?php echo smarty_modifier_f_escape_xml($_smarty_tpl->tpl_vars['val']->value['following']);?>
</div>
<?php }?>
<a href="javascript:void(0);" data-uid="<?php echo smarty_modifier_f_escape_xml($_smarty_tpl->tpl_vars['val']->value['uid']);?>
" data-type="unfollow" class="btn">取消关注</a>
</div>
</div>
</li>
<?php } ?>
...
<?php if(!class_exists('FISResource', false)){require_once('/data/www-data/hupu.com/huputv_frontend/plugin/FISResource.class.php');}FISResource::load('home:page/followList.tpl',$_smarty_tpl->smarty, false);?>
