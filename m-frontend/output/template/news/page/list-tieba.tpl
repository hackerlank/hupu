...
<a dace-node="{%$id4dace|f_escape_xml%}_tiebadownload" section-exposure="{%$id4dace|f_escape_xml%}_tiebashowapp" href="{%$adInfo.m_adapp.baidutieba.adurl|f_escape_xml%}">
<img src="{%$adInfo.m_adapp.baidutieba.pic|f_escape_xml%}" alt=""/>
</a>
</li>
{%/if%}
...
{%/block%}
{%block name="footer"%}
{%require name='news:page/list-tieba.tpl'%}{%/block%}