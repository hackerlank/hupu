    ...
    <dl class="reply-list">
        <dd class="operations-user">
                    <span class="user-name">
                        <a dace-node="{%$id4dace|f_escape_js%}_home" href="/my/<@=item.uid@>"><@=item.user@></a>
                    </span>
                    <span class="operations">
                        ...
                        <a href="javascript:" dace-node="{%$id4dace|f_escape_js%}_quote" class="button-quote J_buttonQuote" data-pid="<@=item.id@>" data-floor="<@=item.floor@>">
