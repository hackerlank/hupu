...
<head>
<meta charset="utf-8"/>
<title>{%$data.header.str_title|f_escape_xml%}</title>
...
{%$ver="2016011502"%}
<link rel="stylesheet" type="text/css" href="{%$host|f_escape_xml%}css/main.css?ver={%$ver|f_escape_path%}" />
...
<script type="text/javascript" src="{%$host|f_escape_xml%}js/start.js?ver={%$ver|f_escape_xml%}"></script>
</body>
</html>