...
<li>
<a href="{%$val.url|f_escape_xml%}" dace-node="{%$id4dace|f_escape_xml%}_5051">
<div class="news-link">
<div class="news-txt">
<h3>{%$val.subject|escape:none%}</h3>
<div class="news-status-bar">
<div class="news-info">
<span class="news-source">{%$val.author|f_escape_xml%}</span>
...
<span class="bright-no">{%$val.lights|f_escape_xml%}</span>{%/if%}
