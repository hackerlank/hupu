...
<td class="number-2">{%$playerInfo.weight|f_escape_xml%}公斤</td>
</tr>
<tr>
<td class="number-1">球队</td>
<td class="number-2">{%$playerInfo.team_name|f_escape_xml%}</td>
</tr>
<tr>
<td class="number-1">生日</td>
<td class="number-2">{%$playerInfo.birth_date|f_escape_xml%}&nbsp;|&nbsp;{%$playerInfo.age|f_escape_xml%}岁</td>
</tr>
<tr>
<td class="number-1">国籍</td>
<td class="number-2">{%$playerInfo.country|f_escape_xml%}</td>
</tr>
<tr>
<td class="number-1">惯用脚</td>
<td class="number-2">{%$foot[$playerInfo.preferred_foot]|f_escape_xml%}</td>
</tr>
{%if $playerInfo["worth"]%}
<tr>
<td class="number-1">身价</td>
<td class="number-2">€{%$playerInfo["worth"]|f_escape_xml%}万</td>
</tr>
{%/if%}
</tbody>
</table>
...
{%require name='teams:page/soccer-players-technical.tpl'%}{%/block%}