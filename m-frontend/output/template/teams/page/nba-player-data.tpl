...
{%widget
        ...
        %}
<nav>
<a href="{%$basicurl|f_escape_xml%}" class="info">基本信息</a><a href="javascript:void(0);" class="active">生涯数据</a>
</nav>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].season|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].team_name|f_escape_xml%}</span>
{%else%}
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].games|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].games_started|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].mins|f_escape_xml%}'</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].pts|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].reb|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].asts|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].stl|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].blk|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].to|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].fga|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].fgp|f_escape_xml%}%</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].foul|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].tpa|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].tpp|f_escape_xml%}%</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].fta|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.REGULAR[$REGULAR_length].ftp|f_escape_xml%}%</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<a href="{%$careerdataurl|f_escape_xml%}" target="_blank" class="all-link">数据表展示></a>
</section>
{%if $playerStats.PLAYOFF|count != 0%}
<section class="mod-data playoff-data">
<h2 class="mod-title-h2"><span class="icon"></span>季后赛</h2>
<div class="bd"><div class="subnav" id="J-playoff-subNav">
<a href="javascript:void(0);"><span>得分</span></a>
<a href="javascript:void(0);" class="active"><span>常规数据</span></a>
<a href="javascript:void(0);"><span>命中率</span></a>
</div>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].season|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>{%/if%}
</span>
<span class="title-col col2">
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].team_name|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].games|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].games_started|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].mins|f_escape_xml%}'</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].pts|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].reb|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].asts|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].stl|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].blk|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].to|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].fga|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].fgp|f_escape_xml%}%</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].foul|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].tpa|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].tpp|f_escape_xml%}%</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].fta|f_escape_xml%}</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<span class="value">{%$playerStats.PLAYOFF[$PLAYOFF_length].ftp|f_escape_xml%}%</span>
{%else%}
<span class="none">--</span>
{%/if%}
</span>
...
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.games_started|f_escape_xml%}/{%$playerStats.REGULAR_AVG.count|f_escape_xml%}</span>
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.games_started|default:"--"|f_escape_xml%}/{%$playerStats.PLAYOFF_AVG.count|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.pts|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.pts|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.reb|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.reb|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.asts|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.asts|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.stl|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.stl|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.blk|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.blk|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.to|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.to|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.fga|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.fga|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.fgp|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.fgp|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.tpa|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.tpa|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.tpp|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.tpp|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.fta|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.fta|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.ftp|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.ftp|default:"--"|f_escape_xml%}</span>
</dd>
<dd>
<span class="col regular-col">{%$playerStats.REGULAR_AVG.foul|f_escape_xml%}</span>
<span class="progress col left-progress">
...
<span class="col playoff-col">{%$playerStats.PLAYOFF_AVG.foul|default:"--"|f_escape_xml%}</span>
</dd>
</dl>
</section>
</section>
{%require name='teams:page/nba-player-data.tpl'%}{%/block%}