...
{%$adids=$ids[$page]%}
<div class="content_bottom_small" style='display:none;' dace-node="{%$id4dace|f_escape_xml%}_ad_{%$adids[0]|f_escape_xml%}">
<script type='text/javascript'>
	googletag.cmd.push(function() { googletag.display('{%$adids[0]|f_escape_js%}'); });
	</script>
</div>
<div class='content_bottom_smaller' style='display:none;' dace-node="{%$id4dace|f_escape_xml%}_ad_{%$adids[1]|f_escape_xml%}">
<script type='text/javascript'>
	googletag.cmd.push(function() { googletag.display('{%$adids[1]|f_escape_js%}'); });
	</script>
</div>
{%script%}
