...
<a href="javascript:" dace-node="{%$id4dace|f_escape_xml%}_open" class="J_buttonSetting {%if $usersetting.thread != 0%}active{%/if%}" data-type="1">开</a>
<a href="javascript:" dace-node="{%$id4dace|f_escape_xml%}_close" class="J_buttonSetting {%if $usersetting.thread == 0%}active{%/if%}" data-type="0">关</a>
</div>
</dt>
{%**
...
{%require name='my:page/setting.tpl'%}{%/block%}