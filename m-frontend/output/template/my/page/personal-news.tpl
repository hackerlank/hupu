...
{%widget
    ...
    banner="{%if $isself %}我{%else%}{%$userinfos.username|f_escape_xml%}{%/if%}最新动态"
%}
...
{%widget
        ...
        page=$userdynamic.page
            urlBase="/my/userdynamic?page=#{page}{%if isset($smarty.get.uid)%}&uid={%$smarty.get.uid|f_escape_xml%}{%/if%}"
    %}
{%require name='my:page/personal-news.tpl'%}{%/block%}