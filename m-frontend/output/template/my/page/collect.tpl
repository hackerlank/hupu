...
{%widget
    ...
    banner="{%if $isself %}我{%else%}{%$userinfos.username|f_escape_xml%}{%/if%}的收藏"
    right="<a href=\"javascript:\" class=\"button-collect\" id=\"J_buttonCollect\" dace-node=\"{%$id4dace|f_escape_xml%}_edit\">编辑</a>"
%}
...
{%widget
    ...
    %}
{%require name='my:page/collect.tpl'%}{%/block%}