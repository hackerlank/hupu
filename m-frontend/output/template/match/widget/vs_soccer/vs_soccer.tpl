...
<img src="{%$val.hlogo|f_escape_xml%}" alt="" class="swiper-lazy">
</a>
{%else%}
<div class="left-logo">
...
{%if !empty($val.alogo)%}
<a class="left-logo" href="javascript:void(0);">
<img src="{%$val.alogo|f_escape_xml%}"alt="" class="swiper-lazy">
</a>
{%else%}
...
{%if !empty($semi.hlogo)%}
<a class="left-logo" href="javascript:void(0);">
<img src="{%$semi.hlogo|f_escape_xml%}" alt="" class="swiper-lazy">
</a>
{%else%}
<div class="left-logo">
...
{%if !empty($semi.alogo)%}
<a class="left-logo" href="javascript:void(0);">
<img src="{%$semi.alogo|f_escape_xml%}" alt="" class="swiper-lazy">
</a>
{%else%}
<div class="right-logo">
...
<a class="left-logo" href="javascript:void(0);">
<img src="{%$final.hlogo|f_escape_xml%}" alt="" class="swiper-lazy">
...
<a class="left-logo" href="javascript:void(0);">
<img src="{%$final.alogo|f_escape_xml%}" alt="" class="swiper-lazy">
...
{%else%}
<div class="left-logo">
<img src="//b1.hoopchina.com.cn/games/teams/chlg/no_pic.png?2016050{%$val@index|f_escape_path%}" alt="" class="swiper-lazy">
</div>
{%/if%}
<div class="middle-info">
{%if $val.round_1 == '未赛'%}
