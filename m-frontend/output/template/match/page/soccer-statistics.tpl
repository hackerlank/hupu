...
{%$home["total_scoring_att"]|f_escape_xml%}
</td>
...
{%$away["total_scoring_att"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["ontarget_scoring_att"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["ontarget_scoring_att"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["won_corners"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["won_corners"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["possession_percentage"]|f_escape_xml%}%</td>
<td class="td-ball td-ball-left">
<div class="ball-progress-bar {%if $home["possession_percentage"] < $away["possession_percentage"]%}lose-ball{%/if%}" style="width: {%$home["possession_percentage"]|f_escape_xml%}%">
</div>
</td>
<td class="type">
控球率</td>
<td class="td-ball">
<div class="ball-progress-bar {%if $home["possession_percentage"] > $away["possession_percentage"]%}lose-ball{%/if%}" style="width: {%$away["possession_percentage"]|f_escape_xml%}%">
</div>
</td>
<td class="ball-number ball-number-right">
{%$away["possession_percentage"]|f_escape_xml%}%</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["total_offside"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["total_offside"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["total_yel_card"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["total_yel_card"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["total_red_card"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["total_red_card"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["total_cross"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["total_cross"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["fk_foul_lost"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["fk_foul_lost"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["att_pen_goal"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["att_pen_goal"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["total_tackle"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["total_tackle"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["interception"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["interception"]|f_escape_xml%}
</td>
</tr>
<tr>
<td class="ball-number ball-number-left">
{%$home["total_pass"]|f_escape_xml%}
</td>
<td class="td-ball td-ball-left">
...
<td class="ball-number ball-number-right">
{%$away["total_pass"]|f_escape_xml%}
</td>
</tr>
</tbody>
</table>
</section>
{%require name='match:page/soccer-statistics.tpl'%}{%/block%}
