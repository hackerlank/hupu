...
{%if $isself %}
    ...
    <div class="m-card my-notif m-card-split-line">
        <div class="card-head">
            <span class="card-title" dace-node="{%$id4dace%}_msm_close">我的消息</span>
        ...
        <div>
            ...
            <a href="/my/notifications" id="J_buttonIgnoreAll" class="button-view-all" dace-node="{%$id4dace%}_7002">{%if $notifications.notificationsinfo|@count > 0%}查看全部消息{%else%}查看历史消息{%/if%}</a>
        </div>
    </div>
