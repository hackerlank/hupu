    ...
    <section class="mod-worldpre-rank">
    	...
    	<div class="main">
			...
			<table class="mod-table">
				<tbody>
					<tr class="tap" @click="goto(subItem)" v-for="subItem in item">
	    				<td width="10%" align="center">
							<!--
							* 亚洲 w173
			...
			<div class="rule" :class="{'short-rule': code == 'w176'}">
				...
				<p v-if="code == 'w175'">当前为中北美区第4轮，三个小组的前两名晋级第5轮，六支队伍在一个组内进行主客场对决，前三名出线，第四名将与亚洲区第4轮的胜者进行附加赛，胜者出线。</p>
