...
<a href="{%$bottom_ad.url|f_escape_xml%}" dace-node="bbs_detailsAd">
<div class="pic">
<img src="{%$bottom_ad.img|f_escape_xml%}" alt=""/>
<span class="mod-mask mask"></span>
</div>
<div class="card-title">
<span class="tags">广告</span>{%$bottom_ad.title|f_escape_xml%}
                            ...
                            <@if (item.puid == author_puid){@>
                                <div class="user-name clearfix">
                                    ...
                                    <a href="<@=item.cert_url@>" class="certification">
                                        <@if(item.cert_type == 2){@>
                                            <img src="//w10.hoopchina.com.cn/hybrid/static/bbs/widget/reply/img/official_ic_day_a41111e.png" alt="official" height="22">
                                        <@}@>
                                        <@if(item.cert_type == 1){@>
                                            <img src="//w10.hoopchina.com.cn/hybrid/static/bbs/widget/reply/img/author_ic_day_ad41382.png" alt="author" height="22">
                                        <@}@>
                                    </a>
                                    </span>
