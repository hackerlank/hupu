...
<a href="kanqiu://news/comment/{%$news.nid|f_escape_path%}?leaguesEn={%$leaguesEn|f_escape_path%}" class="button-viewMore" dace-node="comment_more">查看更多评论({%$news.replies|f_escape_xml%})</a>
</div>
