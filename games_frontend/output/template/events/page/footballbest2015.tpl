...
{%block name="title"%}{%$config['mysharetext']|default:"2015足球最佳阵型"|f_escape_xml%}{%/block%}
...
{%script%}
    	window.GM = {
    		person_fd : "{%$smarty.get.fd|f_escape_js%}",
 		...
 		<div <@if(GM.kanqiu!=-1){@> style="padding-bottom:75px;"<@}@>>
			...
			<div class="top-down-app">
		        <a href="//mobile.hupu.com/download/games?r=201601soccerdreamteam">
		            <div class="hupu-logo">
		                <img src="//w2.hoopchina.com.cn/hybrid/static/events/footballbest2015/img/logo_cf16ee1.png" alt=""/>
		            </div>
		            <div class="app-info">
		                <h4 class="name">
		                    虎扑体育
		                ...
		                <div class="score">
		                    <img src="//w2.hoopchina.com.cn/hybrid/static/events/footballbest2015/img/star_6ab1624.png" alt=""/>
		                </div>
		            </div>
		    ...
		    <@}@>
			<div class="team">
				<img src="//w3.hoopchina.com.cn/hybrid/static/events/footballbest2015/img/result-bg_b52eb84.jpg" alt="">
...
{%require name='events:page/footballbest2015.tpl'%}{%/block%}