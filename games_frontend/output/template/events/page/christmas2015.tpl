...
<script>
    window.GM = {
        "gamestatus": "{%$gamestatus|f_escape_js%}",
        "isweixin": "{%$isweixin|f_escape_js%}",
        "url": "{%$url|f_escape_js%}",
        "friendid": "{%$friendid|f_escape_js%}",
        "haveresult": "{%$haveresult|f_escape_js%}"
    };
    </script>
{%script%}
    wx.config({
        debug: false,
        appId: '{%$config["appId"]|f_escape_js%}',
        timestamp: '{%$config["timestamp"]|f_escape_js%}',
        nonceStr: '{%$config["nonceStr"]|f_escape_js%}',
        signature: '{%$config["signature"]|f_escape_js%}',
        jsApiList: [
    ...
    wx.ready(function () {
        var shareData = {
            title: '{%$share_config['title']|f_escape_js%}',
            desc: '{%$share_config['desc']|f_escape_js%}',
            link: '{%$share_config["share_url"]|f_escape_js%}',
            imgUrl: '{%$share_config["headimgurl"]|f_escape_js%}',
            success:function(){
                window.location.href = "{%$share_config['share_url']|f_escape_js%}";
            },
            cancel:function(){
            }
        };
...
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/bigimg_056ac91.png" alt="">
</section>
<section class="guess mod-content">
{%if $gamestatus == 0%}
<div class="bg-snow auto-bg">
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/bg6_10da721.png" alt="">
</div>
<div class="bg-top auto-bg">
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/bg1_3f72207.png" alt="">
</div>
...
<div class="head">
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/img1_9805bf8.png" width="60" alt="">
</div>
<div class="data">
...
<div class="head">
<img src="//w1.hoopchina.com.cn/hybrid/static/events/christmas2015/img/img2_95c45fa.png" width="60" alt="">
</div>
<div class="data">
...
<div class="head">
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/img3_3040132.png" width="60" alt="">
</div>
<div class="data">
...
<div class="head">
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/img4_5419242.png" width="60" alt="">
</div>
<div class="data">
...
<div class="head">
<img src="//w1.hoopchina.com.cn/hybrid/static/events/christmas2015/img/img5_9bf3cbd.png" width="60" alt="">
</div>
<div class="data">
...
<div class="head">
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/img6_8d773d8.png" width="60" alt="">
</div>
<div class="data">
...
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/bg7_ef7f574.png" alt="">
</div>
...
<div class="result">
<div class="head">
<img src="{%$userinfo.headimgurl|f_escape_xml%}" width="40" alt="">
</div>
<div class="detail">
<div class="info">
<span class="name">{%$userinfo.nickname|f_escape_xml%}</span>
<span class="date">{%$userinfo.subtime|f_escape_xml%}</span>
</div>
<div class="data">{%$userinfo.data|f_escape_xml%}</div>
</div>
</div>
<div class="notice">
你是第<span>{%$userinfo.paimin|f_escape_xml%}</span>名参与者，前6666名猜中用户可以获得10 Q币奖励</div>
<div class="tips">
【分享有奖】分享该链接给你的微信好友，如果你的好友猜中，你也可以获得10 Q币奖励</div>
</div><div class="button share-btn"></div>
...
{%if $userinfo.binggo>0%}
<div class="notice">
你是第<span>{%$userinfo.binggo|f_escape_xml%}</span>名猜中者，前6666名猜中用户可以获得10 Q币奖励</div>
{%/if%}
{%else%}
<div class="qq-query">
...
<div class="qq-img"><img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/qq_79d1840.png" width="36" alt=""></div>
{%if $flag == 0%}
<div class="mod-header">
<div class="icon left"></div>
<div>
<p class="title">
{%if !empty($fdata)%}<span>{%$fdata.nickname|f_escape_xml%}</span>和{%/if%}好友们的竞猜</p>
...
<dd>
<div class="head">
<img src="{%$fdata.headimgurl|f_escape_xml%}" width="40" alt="">
</div>
<div class="f-result">
<div class="info">
<span class="name">{%$fdata.nickname|f_escape_xml%}</span>
<span class="date">{%$fdata.subtime|f_escape_xml%}</span>
</div>
<div class="result">{%$fdata.data|f_escape_xml%}</div>
{%if $gamestatus == 1%}
{%if $haveresult == 1%}
{%if $fdata.binggo > 0%}
<div class="guess-status guess-right"></div>
...
<dd>
<div class="head">
<img src="{%$val.headimgurl|f_escape_xml%}" width="40" alt="">
</div>
<div class="f-result">
<div class="info">
<span class="name">{%$val.nickname|f_escape_xml%}</span>
<span class="date">{%$val.subtime|f_escape_xml%}</span>
</div>
<div class="result">{%$val.data|f_escape_xml%}</div>
{%if $gamestatus == 1%}
{%if $haveresult == 1 %}
{%if $val.binggo > 0%}
<div class="guess-status guess-right"></div>
...
{%if !empty($ismore)%}
<div class="more" id="J-more" data-f="{%$f|f_escape_xml%}">加载更多>>&nbsp;&nbsp;{%if !empty($total)%}
共{%$total|f_escape_xml%}人{%/if%}
</div>
{%/if%}
{%else%}
<dl><dt>
...
<div class="hd">
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/adidas_2b6dc4f.png" alt="">
</div>
<div class="bd">
<ul class="item">
<li class="mr">
<img src="//w3.hoopchina.com.cn/hybrid/static/events/christmas2015/img/gift1_9ba56e9.png" alt="">
</li>
<li class="ml">
<img src="//w1.hoopchina.com.cn/hybrid/static/events/christmas2015/img/gift2_b42ad95.png" alt="">
</li>
</ul>
<ul class="item">
<li class="mr">
<img src="//w1.hoopchina.com.cn/hybrid/static/events/christmas2015/img/gift3_4c1c053.png" alt="">
</li>
<li class="ml">
<img src="//w1.hoopchina.com.cn/hybrid/static/events/christmas2015/img/gift4_bbb1b78.png" alt="">
</li>
</ul>
</div>
</section>
...
<div class="bg-top auto-bg">
<img src="//w1.hoopchina.com.cn/hybrid/static/events/christmas2015/img/bg3_638eea5.png" alt="">
</div>
...
<div class="head-wrap">
<div class="head">
<img src="{%$val.headimgurl|f_escape_xml%}" width="30" alt="">
</div>
<div class="medal"></div>
</div>
<div class="name">{%$val.nickname|f_escape_xml%}</div>
<div class="share">分享参与人数<span class="num">{%$val.nums|f_escape_xml%}</span>人</div>
</li>
{%/if%}
{%/foreach%}
</ul>
...
<a href="//mobile.hupu.com/download/games?r=201512wechat01"><img src="//w2.hoopchina.com.cn/hybrid/static/events/christmas2015/img/fangpb_e3ee123.png" alt=""></a>
</section>
{%/if%}
</section>
...
<div class="btn" id="J-confirm-btn" data-unionid="{%$unionid|f_escape_xml%}" data-f="{%$f|f_escape_xml%}" data-value="123456">确认</div>
</div>
<div class="close close-icon"></div>
</div>
<div class="remind-showBox" style="display: none;"></div>
{%require name='events:page/christmas2015.tpl'%}{%/block%}