...
</div><h3><span>来自：</span><a href="<@=$val.news.url@>" dace-node="newsUrlClick"><@=$val.news.title@></a></h3>
</li>
<@}else{@>
...
<div class="user-info">
<div class="user-name clearfix">
<span class="fl"><a dace-node="post_user" href="kanqiu://people/<@=$val.user_puid@>"><@=$val.user_name@></a></span>
</div>
<div class="source-left">
<@if($val.format_time){@>
<span class="postdate"><@=$val.format_time@></span>
