...
{%else%}
<tr>
<td width="35%" class="type" colspan="2">{%$chinese|f_escape_xml%}</td>
...
<span class="logo">
<img src="{%$val.player_photo|f_escape_xml%}?t={%$val@index|f_escape_path%}"/>
{%if !empty($night)%}
<span class="mask"></span>
{%/if%}
</span>
</td>
<td width="27%" class="td2">{%$val.alias|f_escape_xml%}</td>
<td width="30%" rowspan="2" align="center">{%$val.injury_part_cn|f_escape_xml%}</td>
...
<tr>
<td colspan="3" class="contract">{%$val.team_name|f_escape_xml%}</td>
</tr>
{%/if%}
</table>
</td>
...
{%require name='match:page/all_nba_hurt_info.tpl'%}{%/block%}
