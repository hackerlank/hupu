...
{%/if%}<span class="logo"><img src="//b1.hoopchina.com.cn/games/teams/nba/1_{%$val.tid|f_escape_path%}_2x_alpha.png?t=61" width="28" /></span><span class="name">{%$val.name|f_escape_xml%}</span>
</td>
...
{%else%}
<span class="num">{%$val@index+1%}</span>
{%/if%}<span class="logo"><img src="//b1.hoopchina.com.cn/games/teams/nba/1_{%$val.tid|f_escape_path%}_2x_alpha.png?t=62" width="28" /><span class="name">{%$val.name|f_escape_xml%}</span>
</td>
<td width="8%" align="center">{%$val.win|f_escape_xml%}</td>
<td width="8%" align="center">{%$val.lost|f_escape_xml%}</td>
<td width="20%" align="center">{%$val.gb|f_escape_xml%}</td>
...
{%else%}
<span class="num">{%$val@index+1%}</span>
{%/if%}<span class="logo"><img src="//b1.hoopchina.com.cn/games/teams/cba/2_{%$val.id|f_escape_path%}{%if ($val['id'] == 14) or ($val['id'] == 21)%}_new{%/if%}{%if ($val['id'] == 12)%}_1{%/if%}.png?t=63" width="28" /></span><span class="name">{%$val.name|f_escape_xml%}</span>
</td>
