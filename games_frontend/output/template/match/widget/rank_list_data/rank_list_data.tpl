...
<section class="tab fixed">
<ul id="J-tab">
<li class="tab-team active">球队排行</li>
{%if $type == "nba"%}
<li class="tab-regular" data-type="{%$pageTab|f_escape_xml%}">球员数据</li>
...
{%/if%}<span class="logo"><img class="swiper-lazy" data-src="//b1.hoopchina.com.cn/games/teams/nba/1_{%$val.tid|f_escape_xml%}_2x_alpha.png" width="28" /></span><span class="name">{%$val.name|f_escape_xml%}</span>
</td>
<td width="8%" align="center">{%$val.win|f_escape_xml%}</td>
<td width="8%" align="center">{%$val.lost|f_escape_xml%}</td>
<td width="20%" align="center">{%$val.gb|f_escape_xml%}</td>
...
{%else%}
<span class="num">{%$val@index+1%}</span>
{%/if%}<span class="logo"><img class="swiper-lazy" data-src="//b1.hoopchina.com.cn/games/teams/nba/1_{%$val.tid|f_escape_xml%}_2x_alpha.png" width="28" /><span class="name">{%$val.name|f_escape_xml%}</span>
</td>
<td width="8%" align="center">{%$val.win|f_escape_xml%}</td>
<td width="8%" align="center">{%$val.lost|f_escape_xml%}</td>
<td width="20%" align="center">{%$val.gb|f_escape_xml%}</td>
...
<tr class="link" link="kanqiu://cba/cba/team/{%$val.id|f_escape_xml%}">
<td width="40%">
{%if $val@index+1<=8 %}
<span class="red num">{%$val@index+1%}</span>
{%else%}
<span class="num">{%$val@index+1%}</span>
{%/if%}<span class="logo"><img class="swiper-lazy" data-src="//b1.hoopchina.com.cn/games/teams/cba/2_{%$val.id|f_escape_xml%}{%if ($val['id'] == 14) or ($val['id'] == 21)%}_new{%/if%}{%if ($val['id'] == 12)%}_1{%/if%}.png" width="28" /></span><span class="name">{%$val.name|f_escape_xml%}</span>
</td>
<td width="20%" align="center">{%$val.bout|f_escape_xml%}</td>
<td width="10%" align="center">{%$val.win|f_escape_xml%}</td>
<td width="10%" align="center">{%$val.los|f_escape_xml%}</td>
<td width="20%" align="center">{%$val.rate|f_escape_xml%}</td>
</tr>
{%/foreach%}
</tbody>
</table>
...
{%/if%}
<section class="regular-rank mod-rank swiper-slide swiper-no-swiping" id="J-regular-rank">
								...
								<tbody>
									...
									<@ } @>
										<td width="66%">
											...
											<@ } @><span class="logo"><img class="swiper-lazy" data-src="<@=subItem.player_header@>" /><@if(GM.night){ @><span class="mask"></span><@ } @></span>
											<span class="detail">
...
<section class="daily-rank mod-rank swiper-slide swiper-no-swiping" id="J-daily-rank">
