<section class="tab">
<ul id="J-tab">
<li class="tab-standings-rank" dace-node="{%$league_name|f_escape_xml%}_standings">
<span>
{%$rank[0]["title"]|f_escape_xml%}
{%if $rank[0]["title"] == "球员榜" || $rank[0]["title"] == "球队榜"%}
<i class="new-tag {%if $rank[0]["title"] == "球员榜"%}player-tag{%else%}team-tag{%/if%}">NEW</i>
{%/if%}
</span>
</li>
<li class="tab-player-rank" dace-node="{%$league_name|f_escape_xml%}_playerrank">
<span>
{%$rank[1]["title"]|f_escape_xml%}
...
<li class="tab-team-rank" dace-node="{%$league_name|f_escape_xml%}_teamrank">
<span>
{%$rank[2]["title"]|f_escape_xml%}
...
<li class="tab-transfer-player" dace-node="{%$league_name|f_escape_xml%}_transfermarket">
<span>
{%$rank[3]["title"]|f_escape_xml%}
