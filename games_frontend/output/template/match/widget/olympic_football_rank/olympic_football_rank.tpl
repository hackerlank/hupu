...
{%if $type == "men"%}
{%if $val@index == 0%}A{%else if $val@index == 1%}B{%else if $val@index == 2%}C{%else if $val@index == 3%}D{%/if%}组{%else if $type == "women"%}
{%if $val@index == 0%}E{%else if $val@index == 1%}F{%else if $val@index == 2%}G{%/if%}组{%/if%}
</td>
