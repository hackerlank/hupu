...
<span class="add-on"><i class="icon-chevron-right"></i><a href="./gameList?lid={%$llid|f_escape_path%}">{%$llname|f_escape_xml%}{%if !empty($typeName)%}{%$typeName|f_escape_xml%}{%else%}赛程{%/if%}</a></span>&nbsp; &nbsp;{%/foreach%}
...
<span class="add-on"><i class="icon-chevron-right"></i><a href="./{%$menuLink|f_escape_path%}">{%$menuTitle|f_escape_xml%}</a></span>&nbsp; &nbsp;{%/foreach%}
</td>
</tr>
</table>
{%/if%}
...
{%require name='common:page/layout-admin.tpl'%}{%/body%}
{%/html%}
