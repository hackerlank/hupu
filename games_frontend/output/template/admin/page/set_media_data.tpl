...
<code class="vs">{%$away_score|f_escape_xml%}-{%$home_score|f_escape_xml%}</code>
...
<i class="icon-tags"></i>直播时按钮名称：<input type="text" placeholder="请输入" id="video-play-title" value="{%$video_play_title|f_escape_xml%}">
</div>
<div class="media mod-box">
<strong><i class="icon-tags"></i>添加直播源</strong>&nbsp;&nbsp;&nbsp;&nbsp;<label for="tv"><input id="tv" class="media-radio" data-type="0" type="radio" name="media" checked="checked">电视</label>&nbsp;&nbsp;&nbsp;&nbsp;<label for="live"><input id="live" class="media-radio" data-type="1" type="radio" name="media">网络直播</label>&nbsp;&nbsp;&nbsp;&nbsp;<label for="huputv"><input id="huputv" class="media-radio" data-type="2" type="radio" name="media">虎扑TV</label>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="btn btn-primary" data-type="0" id="J-add-btn">添加</a>
</div>
...
<tr>
<td>直播源名称：</td>
<td><input type="text" class="name" placeholder="请输入" value="{%$val.name|f_escape_xml%}"></td>
<td><a href="javascript:void(0);" class="btn btn-danger delete">删除</a></td>
</tr>
<tr>
<td>视频地址：</td>
<td><input type="text" class="url" placeholder="URL" value="{%$val.url|f_escape_xml%}"></td>
...
<div>
{%require name='admin:page/set_media_data.tpl'%}{%/block%}
