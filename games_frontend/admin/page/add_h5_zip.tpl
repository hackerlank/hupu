    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tr>
                ...
                <td width="25%">
                    <button type="button" class="btn btn-warning btn-sm btn-status" data-status="0" data-id="{%$val.id%}" data-version="{%$val.version%}">禁用</button>
                    <button type="button" class="btn btn-primary btn-sm btn-status" data-status="1" data-id="{%$val.id%}" data-version="{%$val.version%}">内测</button>
                    <button type="button" class="btn btn-danger btn-sm btn-status" data-status="2" data-id="{%$val.id%}" data-version="{%$val.version%}" data-toggle="modal" data-target="#myModal">开放</button>
                    <button type="button" class="btn btn-danger btn-sm btn-status" data-status="3" data-id="{%$val.id%}" data-version="{%$val.version%}" data-toggle="modal" data-target="#myModal">降级</button>
                </td>
                <td width="10%">
                    {%if $val.status == 0%}
                        <code>禁用</code>
